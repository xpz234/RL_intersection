...
# 颜色
COLOR_BUTTER_0 = pygame.Color(252, 233, 79)  # (252, 233, 79, 255)
...
COLOR_ALUMINIUM_3 = pygame.Color(66, 62, 64)  # 背景色  之前的pygame.Color(136, 138, 133) 现在我想让它们一直改的
COLOR_ALUMINIUM_4 = pygame.Color(85, 87, 83)
COLOR_ALUMINIUM_4_5 = pygame.Color(66, 62, 64)  # 路基颜色
COLOR_ALUMINIUM_5 = pygame.Color(46, 52, 54)  # 路面颜色值
...
class MapImage(object):
    ...
    def __init__(self, carla_world, carla_map, pixels_per_meter):
        ...
        waypoints = carla_map.generate_waypoints(2)  # 一组航点距离2米，可视化道路
        margin = 50
        ...
        self.big_map_surface = pygame.Surface((width_in_pixels, width_in_pixels)).convert()  # 在图片上绘制另一个图
    ...
    def draw_road_map(self, map_surface, carla_world, carla_map, world_to_pixel, world_to_pixel_width):
        ...
        map_surface.fill(COLOR_ALUMINIUM_4_5)  # 背景色 3
        precision = 0.05
        ...
        def draw_topology(carla_topology, index):
            ...
            for waypoint in topology:
                ...
                nxt = waypoint.next(precision)  # 车道方向距离precision内的航点
                if len(nxt) > 0:
                    nxt = nxt[0]
                ...
                SIDEWALK_COLOR = COLOR_ALUMINIUM_3  # 人行道颜色
        ...
        topology = carla_map.get_topology()  # 道路拓扑的最小图
...
class BirdeyeRender(object):
    ...
    def __init__(self, world, params):
        ...
        self.server_clock = pygame.time.Clock()  # 创建时钟对象 (可以控制游戏循环频率)

        # World data
        self.world = world
        self.town_map = self.world.get_map()  # 地图
    ...
    def on_world_tick(weak_self, timestamp):
        ...
        self.server_clock.tick()  # 循环次数 标准60
    ...
    def render(self, display, render_types=None):
        ...
        self.render_waypoints(self.waypoints_surface, self.waypoints, self.map_image.world_to_pixel)  # 蓝色导航道路
        ...
        if self.hero_actor is not None:
            ...
            translation_offset = (
                hero_location_screen[0] - self.hero_surface.get_width() / 2 + hero_front.x * self.params[
                    'pixels_ahead_vehicle'],
                (hero_location_screen[1] - self.hero_surface.get_height() / 2 + hero_front.y * self.params[
